# arriendo_local_comida.py
from arriendo import Arriendo

class ArriendoLocalComida(Arriendo):
    def __init__(self, nombre, cuota_base, valor_luz=0, valor_agua=0, iva=0):
    ...
    def establecer_arriendo_mensual(self):
        subtotal = self.obtener_valor_luz() + self.obtener_valor_agua() + self.obtener_cuota_base()
